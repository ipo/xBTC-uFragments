...
module.exports = async function(deployer, network, accounts) {
    ...
    var instanceBcmdOracle = await deployProxy(MedianOracle, [networkSettings['ownerAddress'], 216000, 3600, 1], { deployer })
    ...
    await instanceMigrations.setAddress(sha256('instanceBcmdOracle'), instanceBcmdOracle.address);

    // TODO replace/augment this with CL alternative
